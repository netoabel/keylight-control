...
const Slider = React.forwardRef((_a, ref) => {
    ...
    <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full border border-slate-800 bg-white ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"/>
